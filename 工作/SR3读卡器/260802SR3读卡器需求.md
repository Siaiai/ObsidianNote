...
| 序号  | 完整字节序列                          | 语义            | S2  | S3  | 实际实现 |
| :-: | ------------------------------- | ------------- | :-: | :-: | :--: |
|  1  | `10 FF 05 AA BB CC DD EE`       | 卡号包           |  ✅  |  ✅  |  ✅   |
|  2  | `10 FF 04 46 61 69 6C`          | Fail包         |  ❌  |  ✅  |  ✅   |
...
| ---- | :--: | :--: | :--: | ---------- | --------------- |
|      | 0xFF | 0x7A |  无   | `10 FF 7A` | 进站查询            |
|      | 0xFF | 0x75 |  无   | `10 FF 75` | 下放查询            |
|      | 0xFF | 0x9A |  无   | `10 FF 9A` | 进站 + 切模式2       |
|      | 0xFF | 0x95 |  无   | `10 FF 95` | 下放 + 切模式2       |
|      | 0xFF | 0x9D |  无   | `10 FF 9D` | 切模式3 连续上报       |
|      | 0xFF | 0x90 |  无   | `10 FF 90` | 查版本             |
|      | 0xA0 | 0x05 |  无   | `10 A0 05` | 复位（进Bootloader） |

**发送指令**（读卡器 -> 控制器）

|     | TYPE | CMD  |          DATA          | 完整字节序列                          | 语义            |
| --- | :--: | :--: | :--------------------: | ------------------------------- | ------------- |
|     | 0xFF | 0x05 |         ID[5]          | `10 FF 05 AA BB CC DD EE`       | 卡号包           |
|     | 0xFF | 0x04 |     `46 61 69 6C`      | `10 FF 04 46 61 69 6C`          | Fail包         |
|     | 0xFF | 0x07 | `56 65 72 30 33 31 30` | `10 FF 07 56 65 72 30 33 31 30` | 版本包 "Ver0310" |
