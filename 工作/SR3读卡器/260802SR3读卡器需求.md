...
| HEAD | TYPE | CMD  | DATA | 完整字节序列       | 功能                  |
| ---- | :--: | :--: | :--: | ------------ | ------------------- |
| 0x10 | 0xFF | 0x7A |  无   | `10 FF 7A`   | 进站查询+失能BCC+切进站模式    |
| 0x10 | 0xFF | 0x75 |  无   | `10 FF 75`   | 下放查询+失能BCC+切下放模式    |
| 0x10 | 0xFF | 0x9A |  无   | `10 FF 9A`   | 进站查询+使能BCC+切进站模式    |
| 0x10 | 0xFF | 0x95 |  无   | `10 FF 95`   | 下放查询+使能BCC+切下放模式    |
| 0x10 | 0xA0 | 0x05 |  无   | `10 A0 05`   | 复位读卡器（进Bootloader）  |
| 0x10 | 0xA0 | 0x01 |  无   | `10 A0 01`   | 查询读卡器版本             |
| 0x10 | 0xA0 | 0x02 |  模式  | `10 FF MODE` | 设置读卡器模式,00:进站，01：xi |
