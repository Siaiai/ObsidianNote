...
| :-: | ---------- | --------------- | :-: | :-: | :--: |
|  1  | `10 FF 7A` | 进站查询 + 切模式1     |  ✅  |  ✅  |  ✅   |
|  2  | `10 FF 75` | 下放查询 + 切模式2     |  ✅  |  ✅  |  ✅   |
...
> BCC = HEAD + TYPE + CMD + DATA 所有字节 XOR（代码 `BCC_Check()` 对整个 buffer 做 XOR）。模式1 不带 BCC，模式2/3 带 BCC。`XX` 为 BCC 字节实际值。
### 现SR3指令表
...
| ---- | :--: | :--: | :--: | ---------- | --------------- |
| 0x10 | 0xFF | 0x7A |  无   | `10 FF 7A` | 进站查询            |
| 0x10 | 0xFF | 0x75 |  无   | `10 FF 75` | 下放查询            |
| 0x10 | 0xFF | 0x9A |  无   | `10 FF 9A` | 进站 + 切模式2       |
| 0x10 | 0xFF | 0x95 |  无   | `10 FF 95` | 下放 + 切模式2       |
| 0x10 | 0xFF | 0x9D |  无   | `10 FF 9D` | 切模式3 连续上报       |
| 0x10 | 0xFF | 0x90 |  无   | `10 FF 90` | 查版本             |
| 0x10 | 0xA0 | 0x05 |  无   | `10 A0 05` | 复位（进Bootloader） |

**发送指令**（读卡器 -> 控制器）

| HEAD | TYPE | CMD  |          DATA          | 完整字节序列                          | 语义            |
| ---- | :--: | :--: | :--------------------: | ------------------------------- | ------------- |
| 0x10 | 0xFF | 0x05 |    厂商编号:[1]+衣架ID[4]    | `10 FF 05 AA BB CC DD EE`       | 卡号包           |
| 0x10 | 0xFF | 0x04 |     `46 61 69 6C`      | `10 FF 04 46 61 69 6C`          | Fail包         |
|      |      |      |                        |                                 |               |
|      |      |      |                        |                                 |               |
| 0x10 | 0xA0 | 0x07 | `56 65 72 30 33 31 30` | `10 FF 07 56 65 72 30 33 31 30` | 版本包 "Ver0310" |
