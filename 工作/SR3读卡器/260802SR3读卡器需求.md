...
| 0x10 | 0xA0 | 0x02 |  模式   | `10 A0 MODE`   | 设置读卡器模式<br>MODE `00`:桌面<br>MODE `01`:进站<br>MODE `02`:下放<br>MODE `03`:连续 | 3    |
| 0x10 | 0xA0 | 0x03 | BCC使能 | `10 A0 BCC_EN` | BCC_EN `55`:不带BCC<br>BCC_EN `AA`:带BCC                                   | 3    |
| 0x10 | 0xA0 | 0x04 |       |                |                                                                         |      |
