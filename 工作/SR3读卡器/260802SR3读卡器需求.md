...
| ---- | :--: | :--: | :--: | ---------- | --------------- |
| 0x10 | 0xFF | 0x7A |  无   | `10 FF 7A` | 进站查询+切进站模式      |
| 0x10 | 0xFF | 0x75 |  无   | `10 FF 75` | 下放查询+切下放模式      |
| 0x10 | 0xFF | 0x9A |  无   | `10 FF 9A` | 进站查询带BCC        |
| 0x10 | 0xFF | 0x95 |  无   | `10 FF 95` | 下放查询带BCC        |
| 0x10 | 0xA0 | 0x05 |  无   | `10 A0 05` | 复位（进Bootloader） |
| 0x10 | 0xA0 | 0x01 |  无   | `10 A0 90` | 查版本             |
| 0x10 | 0xA0 | 0x02 |  无   | `10 FF 9D` | 切模式3 连续上报       |
