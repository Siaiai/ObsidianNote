...
![[attachments/sr3-architecture.html]]
...
## 初始化流程 & Reader_Poll 流水线

> 已整合到上方附件 [sr3-architecture.html](attachments/sr3-architecture.html) 中。

## 解码方案

![[attachments/em4095-decode.html]]

> [!tip] 若上方图表不显示
> Obsidian 原生 `![[xxx.html]]` 需要插件支持方可渲染。推荐安装 **Embed HTML** (by mnaoumov) 或 **HTML Page Preview** 插件。
> 备选: 直接在浏览器打开 `attachments/em4095-decode.html`。
